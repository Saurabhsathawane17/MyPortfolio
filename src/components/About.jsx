...
import profileImage from "../assets/work_logo/saurabh profile pic3.png";
...
const About = () => {
  return (
    <section
      id="about"
      className="relative z-0 py-4 px-[7vw] md:px-[7vw] lg:px-[20vw] font-sans mt-16 md:mt-24 lg:mt-32"
       >
